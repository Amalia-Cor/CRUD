				...
				<tbody>
					...
					<c:forEach var="todo" items="${listTodo}">
						...
						<tr>
							...
							<td>
										<a class="btn btn-primary" href="edit?id=<c:out value='${todo.id}' />">Editar</a>
											&nbsp;&nbsp;&nbsp;&nbsp; 
								<a class="btn btn-danger" href="delete?id=<c:out value='${todo.id}' />">Eliminar</a>
